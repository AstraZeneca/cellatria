...
image_info <- rprt$image_build_info
...
```{r, eval=TRUE, warning=FALSE, message=FALSE, echo=FALSE, fig.dim=c(7.0, 5.0), fig.align = 'center', results='asis'}
 plot_projection(fobj, "UMAP1", "UMAP2", "sample_id", smpl_colrs, geomLabelRepel = TRUE, plot_alpha = params$opt$plot_alpha)
```
...
```{r, eval=keyval_batch, warning=FALSE, message=FALSE, echo=FALSE, fig.dim=c(7.0, 5.0), fig.align = 'center', results='asis'}
 plot_projection(obj_noharm, "UMAP1", "UMAP2", "sample_id", smpl_colrs, geomLabelRepel = TRUE, plot_alpha = params$opt$plot_alpha)
```
...
```{r, eval=keyval_tsne, warning=FALSE, message=FALSE, echo=FALSE, fig.dim=c(7.0, 5.0), fig.align = 'center', results='asis'}
 plot_projection(fobj, "TSNE1", "TSNE2", "sample_id", smpl_colrs, geomLabelRepel = TRUE, plot_alpha = params$opt$plot_alpha)
```
...
```{r, eval=keyval_tsne & keyval_batch, warning=FALSE, message=FALSE, echo=FALSE, fig.dim=c(7.0, 5.0), fig.align = 'center', results='asis'}
 plot_projection(obj_noharm, "TSNE1", "TSNE2", "sample_id", smpl_colrs, geomLabelRepel = TRUE, plot_alpha = params$opt$plot_alpha)
```
...
```{r, eval=TRUE, warning=FALSE, message=FALSE, echo=FALSE, fig.dim=c(7.0, 5.0), fig.align = 'center', results='asis'}
 plot_projection(fobj, "UMAP1", "UMAP2", "cluster", clstr_colrs, geomLabelRepel = TRUE, plot_alpha = params$opt$plot_alpha)
```

`r if (keyval_batch) { "### UMAP Projection (no-batch correction)" }`
```{r, eval=keyval_batch, warning=FALSE, message=FALSE, echo=FALSE, fig.dim=c(7.0, 5.0), fig.align = 'center', results='asis'}
 plot_projection(obj_noharm, "UMAP1", "UMAP2", "cluster", clstr_colrs_btch, geomLabelRepel = TRUE, plot_alpha = params$opt$plot_alpha)
```

`r if (keyval_tsne) { "### TSNE Projection" }`
```{r, eval=keyval_tsne, warning=FALSE, message=FALSE, echo=FALSE, fig.dim=c(7.0, 5.0), fig.align = 'center', results='asis'}
 plot_projection(fobj, "TSNE1", "TSNE2", "cluster", clstr_colrs, geomLabelRepel = TRUE, plot_alpha = params$opt$plot_alpha)
```

`r if (keyval_tsne & keyval_batch) {"### TSNE Projection (no-batch correction)"}`
```{r, eval=keyval_tsne && keyval_batch, warning=FALSE, message=FALSE, echo=FALSE, fig.dim=c(7.0, 5.0), fig.align = 'center', results='asis'}
 plot_projection(obj_noharm, "TSNE1", "TSNE2", "cluster", clstr_colrs_btch, geomLabelRepel = TRUE, plot_alpha = params$opt$plot_alpha)
```
...
```{r, eval=keyval_scim, warning=FALSE, message=FALSE, echo=FALSE, fig.dim=c(8.0, 5.0), fig.align = 'center', results='asis'}
 plot_projection(fobj, "UMAP1", "UMAP2", "celltype_scimilarity", cltyp_colrs, plot_alpha = params$opt$plot_alpha)
```
...
```{r, eval=keyval_scim && keyval_tsne, warning=FALSE, message=FALSE, echo=FALSE, fig.dim=c(8.0, 5.0), fig.align = 'center', results='asis'}
 plot_projection(fobj, "TSNE1", "TSNE2", "celltype_scimilarity", cltyp_colrs, plot_alpha = params$opt$plot_alpha)
```
...
```{r, eval=keyval_cltpst, warning=FALSE, message=FALSE, echo=FALSE, fig.dim=c(8.0, 5.0), fig.align = 'center', results='asis'}
 plot_projection(fobj, "UMAP1", "UMAP2", "celltype_celltypist", cltyp_colrs, plot_alpha = params$opt$plot_alpha)
```
...
```{r, eval=keyval_cltpst && keyval_tsne, warning=FALSE, message=FALSE, echo=FALSE, fig.dim=c(8.0, 5.0), fig.align = 'center', results='asis'}
 plot_projection(fobj, "TSNE1", "TSNE2", "celltype_celltypist", cltyp_colrs, plot_alpha = params$opt$plot_alpha)
```
...
```{r eval=keyval_scim && !is.null(Q[["celltype_scimilarity"]]), warning=FALSE, message=FALSE, echo=FALSE, fig.dim=c(17.5, 9.5), fig.align='center', results='asis'}
plot(Q[["celltype_scimilarity"]])
```

`r if (keyval_scim) "### SCimilarity (cell state)"`

```{r eval=keyval_scim && !is.null(Q[["cellstate_scimilarity"]]), warning=FALSE, message=FALSE, echo=FALSE, fig.dim=c(17.5, 9.5), fig.align='center', results='asis'}
plot(Q[["cellstate_scimilarity"]])
```

`r if (keyval_cltpst) "### CellTypist (cell type)"`

```{r eval=keyval_cltpst && !is.null(Q[["celltype_celltypist"]]), warning=FALSE, message=FALSE, echo=FALSE, fig.dim=c(17.5, 9.5), fig.align='center', results='asis'}
plot(Q[["celltype_celltypist"]])
```

`r if (keyval_cltpst) "### CellTypist (cell state)"`

```{r eval=keyval_cltpst && !is.null(Q[["cellstate_celltypist"]]), warning=FALSE, message=FALSE, echo=FALSE, fig.dim=c(17.5, 9.5), fig.align='center', results='asis'}
plot(Q[["cellstate_celltypist"]])
```
...
if (is.null(image_info)) {
  cat("Container build metadata not embedded in this image (image-meta.json not found).")
} else {
  # enforce deterministic key order
  key_order <- c("image_repo", "image_tag", "image_version", "vcs_ref", "build_date", "tree_state")

  # keep only expected keys (gracefully handles extras/missing)
  ks <- intersect(key_order, names(image_info))
  vals <- vapply(ks, function(k) {
    v <- image_info[[k]]
    if (is.null(v) || is.na(v) || length(v) == 0) "" else as.character(v)
  }, character(1))
  ...
  kableExtra::kable(image_df, caption = "Container Build Metadata") %>%
    kableExtra::kable_classic(full_width = FALSE, html_font = "Cambria") %>%
    kableExtra::kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"),
          full_width = FALSE, fixed_thead = TRUE) %>%
    kableExtra::scroll_box(width = "100%", height = "300px")
