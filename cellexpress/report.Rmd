...
if (params$opt$doublet_method == "scrublet") {
...
if (params$opt$annotation_method != "None") {
...
keyval_batch <- ifelse (params$opt$batch_correction != "None", TRUE, FALSE)
...
`r keyval_scr <- params$opt$doublet_method == "scrublet"`
...
used for analysis, including detailed specifications of the R, Python, and Domino execution environments. 
