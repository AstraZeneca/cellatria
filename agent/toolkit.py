...
class CellExpressArgs(BaseModel):
    ...
    batch_correction: Optional[str] = Field(None, description="Method for batch correction: Options: 'harmony' or 'scvi' (default: None).")
    batch_vars: Optional[str] = Field(None, description="Column(s) in adata.obs to use for batch correction. Note: scVI uses a single batch key (default: None).")
