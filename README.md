...
Run the following command in your terminal, replacing `/path/to/your/project/directory` with the path to your project directory:

```bash
docker run --platform=linux/amd64 -it --rm \
  -p 7860:7860 \
  -v $(pwd):/data \
  -v /path/to/your/project/directory:/envdir \
